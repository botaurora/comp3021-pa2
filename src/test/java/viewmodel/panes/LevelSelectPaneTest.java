...
/**
 * Miscellaneous tests for {@link LevelSelectPane}.
 */
public class LevelSelectPaneTest extends ApplicationTest {
    /**
    ...
    void testReturnToMainMenu() {
        ...
        Node leftVBoxNode = currentRoot.getChildrenUnmodifiable().stream()
                .filter(it -> it instanceof VBox && ((VBox) it).getChildren().size() == 4)
                .findFirst()
